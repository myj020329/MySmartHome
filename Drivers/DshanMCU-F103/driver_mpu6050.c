...
void mpu6050_ctrl(void *params)
{
	...
	while (1)
	{
		MPU6050_ReadData(&AccX, NULL, NULL, NULL, NULL, NULL);
		mdata.angle_x = (int32_t)(acos((double)((double)(AccX + MPU6050_X_ACCEL_OFFSET) / 16384.0)) * 57.29577);

		if(mdata.angle_x != 90)   xQueueSendFromISR(g_xQueueMPU6050, &mdata, NULL);
